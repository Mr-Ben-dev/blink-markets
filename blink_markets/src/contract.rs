...
mod tests {
    ...
    use super::{BlinkMarketsContract, BlinkMarketsState};
    ...
    fn create_and_instantiate_app(initial_value: u64) -> BlinkMarketsContract {
        let runtime = ContractRuntime::new().with_application_parameters(());
        let mut contract = BlinkMarketsContract {
            state: BlinkMarketsState::load(runtime.root_view_storage_context())
                .blocking_wait()
